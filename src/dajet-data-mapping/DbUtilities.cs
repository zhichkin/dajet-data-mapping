...
namespace DaJet.Data
{
    public static class DbUtilities
    {
        ...
        public static bool IsAutoGeneratedValue(DatabaseField field)
        {
            return (field.TypeName == "timestamp" || field.TypeName == "rowversion");
        }
        public static object GetDefaultValueAsObject(DatabaseField field)
        {
            if (field.IsNullable)
            {
                return null;
        ...
        public static string GetDefaultValueAsString(DatabaseField field)
        {
            if (field.IsNullable)
            {
                return null;
        ...
        public static string GetValueAsString(DatabaseField field, object value)
        {
        ...
        public static object GetValueFromString(DatabaseField field, string value)
        {
